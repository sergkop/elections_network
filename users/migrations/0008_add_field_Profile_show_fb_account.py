...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.show_fb_account'
        db.add_column('users_profile', 'show_fb_account', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.show_fb_account'
        db.delete_column('users_profile', 'show_fb_account')
