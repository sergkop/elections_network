...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_profile', 'icq', self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.icq'
        db.delete_column('users_profile', 'icq')
