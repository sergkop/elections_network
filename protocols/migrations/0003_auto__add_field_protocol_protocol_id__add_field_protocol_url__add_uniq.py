...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Protocol.protocol_id'
        db.add_column('protocols_protocol', 'protocol_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Protocol.url'
        db.add_column('protocols_protocol', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)

        # Adding unique constraint on 'Protocol', fields ['object_id', 'content_type', 'protocol_id']
        db.create_unique('protocols_protocol', ['object_id', 'content_type_id', 'protocol_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Protocol', fields ['object_id', 'content_type', 'protocol_id']
        db.delete_unique('protocols_protocol', ['object_id', 'content_type_id', 'protocol_id'])

        # Deleting field 'Protocol.protocol_id'
        db.delete_column('protocols_protocol', 'protocol_id')

        # Deleting field 'Protocol.url'
        db.delete_column('protocols_protocol', 'url')
