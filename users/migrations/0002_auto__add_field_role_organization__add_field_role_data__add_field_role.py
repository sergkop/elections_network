...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Role.organization'
        db.add_column('users_role', 'organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organizations.Organization'], null=True, blank=True), keep_default=False)

        # Adding field 'Role.data'
        db.add_column('users_role', 'data', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'Role.verified'
        db.add_column('users_role', 'verified', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Role.organization'
        db.delete_column('users_role', 'organization_id')

        # Deleting field 'Role.data'
        db.delete_column('users_role', 'data')

        # Deleting field 'Role.verified'
        db.delete_column('users_role', 'verified')
    ...
    models = {
        ...
        'users.role': {
            ...
            'data': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
