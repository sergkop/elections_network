...
urlpatterns = patterns('navigation.views',
    ...
    tabbed_static_url('campaign', 'static_pages/campaign/campaign.html'),
    tabbed_static_url('pressure', 'static_pages/campaign/pressure.html'),
    tabbed_static_url('observation', 'static_pages/campaign/observation.html'),
    tabbed_static_url('behaviour', 'static_pages/campaign/behaviour.html'),
    tabbed_static_url('how_to_use', 'static_pages/campaign/how_to_use.html'),

    tabbed_static_url('news', 'static_pages/development/base.html'),
    tabbed_static_url('functionality', 'static_pages/about/base.html'),
