...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_profile', 'address', self.gf('django.db.models.fields.CharField')(default=2, max_length=250), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.address'
        db.delete_column('users_profile', 'address')
