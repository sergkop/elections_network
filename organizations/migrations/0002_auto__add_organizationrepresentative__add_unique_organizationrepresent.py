...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OrganizationRepresentative'
        db.create_table('organizations_organizationrepresentative', (
        ...
        db.send_create_signal('organizations', ['OrganizationRepresentative'])

        # Adding unique constraint on 'OrganizationRepresentative', fields ['organization', 'user']
        db.create_unique('organizations_organizationrepresentative', ['organization_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'OrganizationRepresentative', fields ['organization', 'user']
        db.delete_unique('organizations_organizationrepresentative', ['organization_id', 'user_id'])

        # Deleting model 'OrganizationRepresentative'
        db.delete_table('organizations_organizationrepresentative')
