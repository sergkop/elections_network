...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organization.signup_lawyers'
        db.add_column('organizations_organization', 'signup_lawyers', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organization.signup_lawyers'
        db.delete_column('organizations_organization', 'signup_lawyers')
