...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_profile', 'region', self.gf('django.db.models.fields.CharField')(default=1, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.region'
        db.delete_column('users_profile', 'region')
