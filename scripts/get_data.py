...
regexp_results =   re.compile('<tr bgcolor="#......">\s*<td style="color:black">(\d+)</td>\s*<td style="color:black">(.*?)</td>\s*<td style="color:black" align="right"><b>(.+?)</b><br>\s*(?:\d+\.\d+\%)?\s*</td>\s*</tr>', re.S)
