...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UnsubscribedUser'
        db.create_table('users_unsubscribeduser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['grakon.Profile'], unique=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('users', ['UnsubscribedUser'])


    def backwards(self, orm):
        
        # Deleting model 'UnsubscribedUser'
        db.delete_table('users_unsubscribeduser')
    ...
    models = {
        ...
        'users.message': {
            ...
            'from_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sender'", 'to': "orm['grakon.Profile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'show_email': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'to_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reciever'", 'to': "orm['grakon.Profile']"})
        },
        'users.role': {
        ...
        'users.unsubscribeduser': {
            'Meta': {'object_name': 'UnsubscribedUser'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['grakon.Profile']", 'unique': 'True'})
        },
        'users.webobserver': {
