...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Organization', fields ['title']
        db.create_index('organizations_organization', ['title'])


    def backwards(self, orm):
        
        # Removing index on 'Organization', fields ['title']
        db.delete_index('organizations_organization', ['title'])
