...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('protocols_attachedfile', (
        ...
        db.send_create_signal('protocols', ['AttachedFile'])

        # Adding field 'Protocol.chairman'
        db.add_column('protocols_protocol', 'chairman', self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True), keep_default=False)

        # Adding field 'Protocol.assistant'
        db.add_column('protocols_protocol', 'assistant', self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True), keep_default=False)

        # Adding field 'Protocol.secretary'
        db.add_column('protocols_protocol', 'secretary', self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True), keep_default=False)

        # Adding field 'Protocol.number'
        db.add_column('protocols_protocol', 'number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Protocol.recieve_time'
        db.add_column('protocols_protocol', 'recieve_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'AttachedFile'
        db.delete_table('protocols_attachedfile')

        # Deleting field 'Protocol.chairman'
        db.delete_column('protocols_protocol', 'chairman')

        # Deleting field 'Protocol.assistant'
        db.delete_column('protocols_protocol', 'assistant')

        # Deleting field 'Protocol.secretary'
        db.delete_column('protocols_protocol', 'secretary')

        # Deleting field 'Protocol.number'
        db.delete_column('protocols_protocol', 'number')

        # Deleting field 'Protocol.recieve_time'
        db.delete_column('protocols_protocol', 'recieve_time')
