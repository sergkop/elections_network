...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_message', (
            ...
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sender', to=orm['grakon.Profile'])),
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reciever', to=orm['grakon.Profile'])),
