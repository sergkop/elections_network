...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organization.observer_coordination'
        db.add_column('organizations_organization', 'observer_coordination', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Organization.mobile_groups'
        db.add_column('organizations_organization', 'mobile_groups', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Organization.signup_journalists'
        db.add_column('organizations_organization', 'signup_journalists', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Organization.news_publishing'
        db.add_column('organizations_organization', 'news_publishing', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Organization.elections_info'
        db.add_column('organizations_organization', 'elections_info', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organization.observer_coordination'
        db.delete_column('organizations_organization', 'observer_coordination')

        # Deleting field 'Organization.mobile_groups'
        db.delete_column('organizations_organization', 'mobile_groups')

        # Deleting field 'Organization.signup_journalists'
        db.delete_column('organizations_organization', 'signup_journalists')

        # Deleting field 'Organization.news_publishing'
        db.delete_column('organizations_organization', 'news_publishing')

        # Deleting field 'Organization.elections_info'
        db.delete_column('organizations_organization', 'elections_info')
