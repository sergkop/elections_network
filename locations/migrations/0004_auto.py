...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Location', fields ['y_coord']
        db.create_index('locations_location', ['y_coord'])

        # Adding index on 'Location', fields ['x_coord']
        db.create_index('locations_location', ['x_coord'])


    def backwards(self, orm):
        
        # Removing index on 'Location', fields ['x_coord']
        db.delete_index('locations_location', ['x_coord'])

        # Removing index on 'Location', fields ['y_coord']
        db.delete_index('locations_location', ['y_coord'])
