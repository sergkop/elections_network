...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Violation', fields ['type', 'content_type', 'violation_id']
        db.delete_unique('violations_violation', ['type', 'content_type_id', 'violation_id'])

        # Adding unique constraint on 'Violation', fields ['object_id', 'content_type', 'violation_id']
        db.create_unique('violations_violation', ['object_id', 'content_type_id', 'violation_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Violation', fields ['object_id', 'content_type', 'violation_id']
        db.delete_unique('violations_violation', ['object_id', 'content_type_id', 'violation_id'])

        # Adding unique constraint on 'Violation', fields ['type', 'content_type', 'violation_id']
        db.create_unique('violations_violation', ['type', 'content_type_id', 'violation_id'])
